...
import { Heartbeat, type HeartbeatDeps } from './heartbeat.js';
 ...
 * port. Swapping any argument (source, clock) or editing this factory is the
 * single place production adapters get plugged in.
 */
